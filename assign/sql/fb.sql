...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1572981342ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="256">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fb&table=like_post">`fb`.`like_post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fb&table=follow">`fb`.`follow`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fb&table=user">`fb`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fb&table=comment">`fb`.`comment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fb&table=post">`fb`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodorderdb&table=table_reservation">`foodorderdb`.`table_reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodorderdb&table=table_reservation_status">`foodorderdb`.`table_reservation_status`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodorderdb&table=order_status">`foodorderdb`.`order_status`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodorderdb&table=opening_hour_entity">`foodorderdb`.`opening_hour_entity`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodorderdb&table=week_day">`foodorderdb`.`week_day`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="60392c4c3747234248255c657a392458">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="256"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fb" targettable="comment">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fb" targettable="like_post">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `like_post`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fb" targettable="comment">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fb" targettable="follow">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `follow`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fb" targettable="follow">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `follow` WHERE `follow`.`id` = 5</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fb" targettable="follow">
                            <div class="action_content">
